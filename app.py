...
# Light and dark are two complete self-contained CSS blocks. Picking one based
...
# Component rules — same for both themes, using the vars defined above.
_MODERNIST_RULES = """
...
.stButton > button:hover, .stDownloadButton > button:hover, .stLinkButton > a:hover {
    background: var(--color-hover-tint) !important;
